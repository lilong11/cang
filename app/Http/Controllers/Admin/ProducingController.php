...
class ProducingController extends Controller
{

    public function index()
    {
        $data = Producing_bundle::paginate(6);
        return view('admin.producing_bundle.index',compact('data'));
    }
    ...
    {
        return view('admin.producing_bundle.add');
    }
    /**
     * creates
     */
...
//                        dd($round);
                        ...
                        return redirect($_SERVER['HTTP_REFERER'])->with('message', 'Add '.$newarrs.' , Insert '.$failed.' failed');
                    }else{
